...
// TODO: swap with real API call — GET /api/provider/restaurant
const restaurant = {
  id: "4fbfd7a0-ff76-45d4-828b-793eed7e9002",
  userId: "irKCD6938htRNKwqFEPbPyTjXkWbXmUI",
  businessName: "Soikot Food Corner",
  logo: "https://example.com/logo.png",
  banner: "https://example.com/banner.png",
  description: "We provide fresh and healthy homemade meals.",
  ...
  tags: [] as string[],
  isVerified: false,
  createdAt: "2026-05-31T13:48:29.098Z",
  updatedAt: "2026-05-31T13:48:29.098Z",
  user: {
    id: "irKCD6938htRNKwqFEPbPyTjXkWbXmUI",
    name: "Soikot",
      ...
      <Card className="overflow-hidden p-0">
        ...
        <CardContent className="pt-14 pb-6">
          <div className="flex items-center gap-2">
            <h2 className="text-xl font-semibold">{restaurant.businessName}</h2>
          ...
          <div className="mt-5 grid grid-cols-3 gap-3 sm:max-w-md">
            ...
            <div className="rounded-xl border bg-muted/50 p-3">
              ...
              <p className="mt-0.5 text-xs text-muted-foreground">Min order</p>
            </div>
          </div>
        </CardContent>
      </Card>
